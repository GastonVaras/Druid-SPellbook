...
function createSpellCard(spell) {
    ...
    preparedButton.classList.add("toggle-button");
    ...
    favoriteButton.classList.add("toggle-button");
    ...
    // if (spell.viewMode === "full-view") {
    //     // Mostrar todos los elementos
    //     spellCard.classList.add("full-view");
    //     spellCard.classList.remove("details-view", "compact-view");
    // } else if (spell.viewMode === "details-view") {
    //     // Mostrar solo el nombre y el nivel del hechizo
    //     spellCard.classList.add("details-view");
    //     spellCard.classList.remove("full-view", "compact-view");
    // } else {
    //     // Mostrar todos los elementos excepto la descripción
    //     spellCard.classList.add("compact-view");
    //     spellCard.classList.remove("full-view", "details-view");
    // }
...
compactViewButton.id = "compact-view-button";
const detailsViewButton = document.createElement("button");
detailsViewButton.id = "details-view-button";
const fullViewButton = document.createElement("button");
fullViewButton.id = "full-view-button";
...
document.getElementById("spell-manager").appendChild(compactViewButton);
document.getElementById("spell-manager").appendChild(detailsViewButton);
document.getElementById("spell-manager").appendChild(fullViewButton);
